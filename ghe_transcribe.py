...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str, default=None, help='Device to use (cuda, mps, or cpu). Defaults to auto-detection.')
    parser.add_argument('--whisper_model', type=str, default='large-v3-turbo', help='Faster Whisper model to use.')
    ...
    parser.add_argument('--word_timestamps', default=None, help='Enable word timestamps in Whisper output.')
    parser.add_argument('--vad_filter', default=False, help='Enable voice activity detection in Whisper.')
