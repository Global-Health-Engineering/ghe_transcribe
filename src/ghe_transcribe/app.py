...
class GheTranscribeApp:
    ...
    def _create_dropdown_from_enum(self, enum_class, description, default_value_from_config):
    ...
    def _setup_ui(self):
        ...
        self.cpu_threads_input = widgets.IntText(
            value=transcribe_config.get("cpu_threads") or 0, # 0 can mean auto/system default
        ...
        with self.output_area:
            ...
            try:
                ...
                kwargs = {
                    ...
                    "cpu_threads": self.cpu_threads_input.value if self.cpu_threads_input.value > 0 else None,
